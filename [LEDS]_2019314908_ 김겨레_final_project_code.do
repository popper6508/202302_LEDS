...
gen 자동화지수2 = 기계장치가액/총인건비 // 자동화지수 변수 생성
...
** 2005년부터 2011년 데이터를 모두 가진 사업체 추리기

reshape wide (산업분류 사업체업력 전체근로자 기간제근로자 파견합계 노동조합조직형태 전체조합원 cpi 당기매출액 급여총액 복리후생비 인건비 연초기계장치 연말기계장치 단독다수사업장 국내사업장수 국외사업장수 조직유형 기업경영체제 외국인지분율 주력제품경쟁강도 퇴직급여 총인건비 매출액 보호대상비율2005 보호대상합계2005 afterlaw1 기계장치가액 자동화지수2 노동조합원비율 단독사업장 개인사업장 회사법인 학교의료법인 소유경영체제 소유주중심 주요경영문제결정권소유주 전문경영인 기업별노동조합 산업별노동조합 지역별노동조합 기타노동조합형태 제조업 after_treat1 manu_treat1 after_manu1 after_manu_treat1), i(id) j(year)

drop if (산업분류2005 == .) | (산업분류2007 == .) | (산업분류2009 == .) | (산업분류2011 == .)

reshape long 산업분류 사업체업력 전체근로자 기간제근로자 파견합계 노동조합조직형태 전체조합원 cpi 당기매출액 급여총액 복리후생비 인건비 연초기계장치 연말기계장치 단독다수사업장 국내사업장수 국외사업장수 조직유형 기업경영체제 외국인지분율 주력제품경쟁강도 퇴직급여 총인건비 매출액 보호대상비율2005 보호대상합계2005 afterlaw1 기계장치가액 자동화지수2 노동조합원비율 단독사업장 개인사업장 회사법인 학교의료법인 소유경영체제 소유주중심 주요경영문제결정권소유주 전문경영인 기업별노동조합 산업별노동조합 지역별노동조합 기타노동조합형태 제조업 after_treat1 manu_treat1 after_manu1 after_manu_treat1, i(id) j(year)
/// 507개 사업체

merge n:1 year using "gdp_growth" // GDP 성장률 데이터와 사업체 데이터 병합

drop if year>=2012
drop if year==2004|year==2006|year==2008|year==2010 // 병합 후 불필요한 데이터 제거
...
** 삼중차분법에 따른 회귀분석 진행
regress (자동화지수2) (보호대상비율2005 afterlaw1 제조업 after_treat1 manu_treat1 after_manu1 after_manu_treat1 노동조합원비율 단독사업장 개인사업장 회사법인 학교의료법인 소유경영체제 소유주중심 주요경영문제결정권소유주 전문경영인 기업별노동조합 산업별노동조합 지역별노동조합 기타노동조합형태 cpi treat_gdp 주력제품경쟁강도 gdp_g)
